    ...
    'h.leona': {
        ...
        "fields": [
            ...
            },
            {
                ...
                "value": `使目標受到傷使自身攻擊力增加10/20/30/40/50%(3回合)、再以自身最大HP30/35/40/45/50％對自身施放護盾(1回合)、並獲得嘲諷效果(1回合)且變為防禦狀態、並使自身獲得「被攻擊時，觸發「進入防禦狀態」(3回合)」、再使目標受到傷害增加5/10/15/20/25%(3回合)，CD: 3害增加15/15/20/20/25%(最多1層)、再以自身攻擊力330/376/422/468/514％對目標造成傷害，CD:4`
            },
            {
